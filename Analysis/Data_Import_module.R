...
#----------------------------------------------------------------------------------------
#
#   Data preperation - Transformation the data into vectors and time series   
#
#----------------------------------------------------------------------------------------

# First we transformation the data that is already loaded by a previous module into vectors and time series
